      ...
      ws.on('message', function incoming(message) {
        ...
        switch (msg.type) {
          case 'pub':
            ...
            channel.request("worker.createRouter", { "routerId": 111111 }, {})
              .then((data) => {
                // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 222222 }, { "tcp": false, ipv4: '192.168.199.110' })
                channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 222222 }, { "tcp": false, ipv4: '100.100.81.209' })
                  // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 222222 }, { "tcp": false, ipv4: '123.59.184.112' })
                  .then((data) => {
                    ...
                    channel.request("transport.setMaxBitrate", { "routerId": 111111, "transportId": 222222 }, { bitrate: 1200000 })
                      .then((data) => {
                        channel.request("transport.setRemoteDtlsParameters", { "routerId": 111111, "transportId": 222222 }, dtlsdata)
                          .then((data) => {
                            channel.request("router.createProducer", { "routerId": 111111, "transportId": 222222, "producerId": 333333 }, audiodata)
                              .then((data) => {
                                channel.request("router.createProducer", { "routerId": 111111, "transportId": 222222, "producerId": 3333333 }, videodata)
                                  .then((data) => {
                                    var pubsdp = {
                                      op: 'pub',
                                      type: 'answer',
          ...
          case 'sub1':
            ...
            channel.request("router.createConsumer", { "routerId": 111111, "producerId": 333333, "consumerId": 444444 }, { kind: 'audio', pubAudioCodec: pubData.audio.payloadType, subAudioCodec: subData.audio.payloadType })
              .then((data) => {
                channel.request("router.createConsumer", { "routerId": 111111, "producerId": 3333333, "consumerId": 4444444 }, { kind: 'video', pubVideoCodec: pubData.video.payloadType, subVideoCodec: subData.video.payloadType, pubRtxCodec: pubData.video.rtx.payloadType, subRtxCodec: subData.video.rtx.payloadType })
                  .then((data) => {
                    // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 555555 }, { "tcp": false, ipv4: '192.168.199.111' })
                    channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 555555 }, { "tcp": false, ipv4: '100.100.81.207' })
                      // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 555555 }, { "tcp": false, ipv4: '106.38.199.123' })
                      .then((data) => {
                        var algorithm = data.dtlsLocalParameters.fingerprints[2].algorithm;
                        var value = data.dtlsLocalParameters.fingerprints[2].value;
                        var ufrag = data.iceLocalParameters.usernameFragment;
                        ...
                        var sdp = encodeSdp(params);
                        channel.request("transport.setRemoteDtlsParameters", { "routerId": 111111, "transportId": 555555 }, dtlsdata)
                          .then((data) => {
                            channel.request("consumer.enable", { "routerId": 111111, "transportId": 555555, "producerId": 333333, "consumerId": 444444 }, enableaudio)
                              .then((data) => {
                                channel.request("consumer.enable", { "routerId": 111111, "transportId": 555555, "producerId": 3333333, "consumerId": 4444444 }, enablevideo)
                                  .then((data) => {
                                    var subsdp = {
                                      op: 'sub1',
                                      type: 'answer',
          ...
          case 'sub2':
            ...
            channel.request("router.createConsumer", { "routerId": 111111, "producerId": 333333, "consumerId": 666666 }, { kind: 'audio', pubAudioCodec: pubData.audio.payloadType, subAudioCodec: subData.audio.payloadType })
              .then((data) => {
                channel.request("router.createConsumer", { "routerId": 111111, "producerId": 3333333, "consumerId": 6666666 }, { kind: 'video', pubVideoCodec: pubData.video.payloadType, subVideoCodec: subData.video.payloadType, pubRtxCodec: pubData.video.rtx.payloadType, subRtxCodec: subData.video.rtx.payloadType })
                  .then((data) => {
                    // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 777777 }, { "tcp": false, ipv4: '192.168.199.112' })
                    channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 777777 }, { "tcp": false, ipv4: '100.100.81.206' })
                      // channel.request("router.createWebRtcTransport", { "routerId": 111111, "transportId": 777777 }, { "tcp": false, ipv4: '111.206.235.91' })
                      .then((data) => {
                        var algorithm = data.dtlsLocalParameters.fingerprints[2].algorithm;
                        var value = data.dtlsLocalParameters.fingerprints[2].value;
                        var ufrag = data.iceLocalParameters.usernameFragment;
                        ...
                        var sdp = encodeSdp(params);
                        channel.request("transport.setRemoteDtlsParameters", { "routerId": 111111, "transportId": 777777 }, dtlsdata)
                          .then((data) => {
                            channel.request("consumer.enable", { "routerId": 111111, "transportId": 777777, "producerId": 333333, "consumerId": 666666 }, enableaudio)
                              .then((data) => {
                                channel.request("consumer.enable", { "routerId": 111111, "transportId": 777777, "producerId": 3333333, "consumerId": 6666666 }, enablevideo)
                                  .then((data) => {
                                    var subsdp = {
                                      op: 'sub2',
                                      type: 'answer',
